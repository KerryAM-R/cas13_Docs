...
- Type of Plot
    - the user can display the data as either Counts (0 to U-0221E) or Proportions (0 to 1)
...
- the opening section shows the total number of guides presented for further filtering
